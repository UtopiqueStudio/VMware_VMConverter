...
namespace VMConverter {
    ...
    class Program {
        ...
        void Run(string[] args) {
            ...
            System.Console.WriteLine("Converter server: " + _converterServerName + " | Job: " + _converterJob);
            ...
            try {
                _converterServer.UpdateJob(_converterJob, newParams);
            } catch (Exception ex) {
            ...
            do {
                ...
                switch (keyValuePair[0]) {
                    ...
                    case "vcserver.password":
                        ...
                        break;
                    case "converterserver.job.number":
                        _converterJob = keyValuePair[1];
                        break;
